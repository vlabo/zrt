...
static int uart_get_port_index(UART_MemMapPtr base) {
...
static void uart_setup(UART_MemMapPtr base, int baud) {
...
static void uart_putchar(UART_MemMapPtr base, char ch) {
...
static void uart_putline(UART_MemMapPtr base, char * str) {
  while (*str != '\0') {
